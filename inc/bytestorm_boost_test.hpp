...
// class TCPConnection : public boost::enable_shared_from_this<Connection>,
//                       boost::noncopyable,
...
//     static Connection create(size_t buffer_size, Handler *h = nullptr);
//     static void setPort(int port);

// private:
//     static void handle_accept(Connection connection, const Error &err, Handler *h = nullptr);
