...
//     async_read(*sock,
//                buffer(rx_buffer),
//                this->bind(&TCPConnection::read_complete, _1, _2),
//                this->bind(&TCPConnection::on_read, _1, _2));
// }
...
//     sock->async_write_some(buffer(tx_buffer, size), this->bind(&TCPConnection::on_write, _1, _2));
// }
...
// ByteStormBoost::ByteStormBoost(int port, size_t buffer_size)
// {
//     ByteStormBoost::setPort(port);
// }

// void ByteStormBoost::setPort(int port)
// {
//     ByteStormBoost::port = port;
// }

// Connection ByteStormBoost::create(size_t buffer_size, Handler *h)
// {
//     Connection new_(new TCPConnection(ByteStormBoost::service, ByteStormBoost::buffer_size, h));
//     return new_;
// }
...
//     auto sock = new_client->sock = new ip::tcp::socket(service);
//     acc.async_accept(*sock, boost::bind(ByteStormBoost::handle_accept, new_client, _1, h));
// }
